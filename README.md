...
the **Synthius-Mem** paper's principles as a lightweight, file-based memory system that runs
...
```bash
# macOS / Linux
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/synthius-mem-claude/main/install.sh | bash

# Windows (PowerShell)
irm https://raw.githubusercontent.com/YOUR_USERNAME/synthius-mem-claude/main/install.ps1 | iex
```

Or manually:

```bash
git clone https://github.com/YOUR_USERNAME/synthius-mem-claude.git
